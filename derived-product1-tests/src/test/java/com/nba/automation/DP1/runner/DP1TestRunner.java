package com.nba.automation.DP1.runner;
...
@CucumberOptions(
    features = "src/test/resources/features/DP1_Home.feature",
    glue = {"com.nba.automation.DP1.steps","com.nba.automation.framework"},
